...
INSERT INTO `t_user` (`uid`,`username`,`password`,`create_dt`,`update_dt`,`name`,
											`pwdsalt`,`type`, `gender`, `mobile`, `state`, `birthday`)
VALUES (${superadmin.uid},'superadmin',${superadmin.password},CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,
	'superadmin',${superadmin.salt},0, 0, '13800000000', 0,CURRENT_TIMESTAMP);
...
INSERT INTO `t_role` VALUES (3, 'customer', '客户', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
